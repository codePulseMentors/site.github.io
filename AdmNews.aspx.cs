...
public partial class AdmNews : System.Web.UI.Page
{
    ...
    {
        dt = obj.showWithOutProcedure("select * from tbNewsRecord where type='1'  order by nid desc");
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        obj.queryWithOutProcedure("insert into tbNewsRecord values(N'" + txtHead.Text + "',N'" + txtNewsDetail.Text + "','" + pth + "','1')");
        txtHead.Text = "";
        txtNewsDetail.Text = "";
        databindNewsRecord();
    }
    ...
    {
        Response.Redirect("AdmEvents.aspx");
    }
