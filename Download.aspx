<%@ Page Title="" Language="C#" MasterPageFile="~/customer.master" AutoEventWireup="true" CodeFile="Download.aspx.cs" Inherits="Download" %>
    ...
    <div id="content_section">
				<!-- Col1 -->
                	<div class="col1">
                    	<!-- Banner -->
                        	<%--<div id="banner1">
									<a href="#"><img src="StaticImages/banner1.jpg" style="width:100%" alt="" /></a>
                         ...
                         <!-- Content Heading -->
                         	<div id="content2">	
                                <h2 class="pad8">Welcome to Saini Education Society </h2><br /><br />
