                    	...
                    	<!-- Col1 -->
                        	<div class="categorydiv">
                            	<ul>
                                   ...
                                   <%-- <li><a href="#EC">Eligibility Criteria 10th</a></li>
                                    <li><a href="#EC">Eligibility Criteria 11th</a></li>
                                    <li><a href="#EC">Eligibility Criteria 12th</a></li>--%>
                    		...
                    		<div class="thumbdiv hideScrollbar" style="height:720px;overflow:scroll;scroll-behavior:smooth;">
                                ...
                                <div style="text-align:justify">
                                    <div id="ap">
                                        ...
                                        <div><span style="color:blue;font-weight:600;font-size:14px">Director : </span>1111111111</div>
                                        <div><span style="color:blue;font-weight:600;font-size:14px">Principal : </span>222222222</div>
                                        <div><span style="color:blue;font-weight:600;font-size:14px">Admission Committee : </span>333333333333</div>
                                    ...
                                    <div id="EC" style="margin-bottom:390px;">
                                        ...
                                        <p>
                                            <table border="2" cellspacing="0">
                                                ...
                                                <tr><td>10th</td><td>3 Years (Regular)</td><td>Graduation in any discipline with Minimum 50% marks (47.5% for SC/ST)</td><td>Rs. 45000/-PA.</td></tr>
                                                <tr><td>11th</td><td>2 Years (Regular)</td><td>BCA or B.Sc./B.Com/B.A. with Maths (Graduation with 50% (47.5% for SC/ST))</td><td>Rs. 45000/-PA.</td></tr>
                                                <tr><td>12th</td><td>1 Years (Regular)</td><td>10+2 in any discipline with Minimum 45% marks</td><td>Rs. 35000/-PA.</td></tr>
                                            </table>
                                        </p><br /><br />
                                        <a href="DownloadableFiles/Documents/Application form.pdf" target="_blank" style="text-decoration:none;float:right;font-size:14px;background-color:#0086b2;color:white;padding:3px 8px">Click here to download the APPLICATION FORM</a>                                        <br /><br />
